...
form.addEventListener("submit", function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, phone, summary, degree, institution, educationStartDate, educationEndDate, skills, resumeHTML;
    return __generator(this, function (_a) {
        ...
        resumeHTML = "\n        <div class=\"profile-section\">\n            <h3>".concat(name, "</h3>\n        </div>\n        <p><strong>Email:</strong> ").concat(email, "</p>\n        <p><strong>Phone:</strong> ").concat(phone, "</p>\n        <hr>\n        <h4>Professional Summary</h4>\n        <p>").concat(summary, "</p>\n        <hr>\n        <h4>Education</h4>\n        <p><strong>").concat(degree, "</strong> from ").concat(institution, " (").concat(educationStartDate, " - ").concat(educationEndDate, ")</p>\n        <hr>\n        <h4>Skills</h4>\n        <p>").concat(skills, "</p>\n        \n    ");
